...
[tickets](https://github.com/craterdog/go-development-tools/issues)
...
following:
 ...
 1. Make sure that all code changes and new code meet the coding conventions for
    the [class model](https://github.com/craterdog/go-class-model/wiki)
...
[discussion area](https://github.com/craterdog/go-development-tools/discussions)
for this project.
